<template>
  <div class="pt-3">
    <!-- This is to test if the component will load in app.vue -->
    <!-- <h1>TODO List</h1> -->
    <v-row class="d-flex justify-center">

      <v-col cols="6">
        <v-text-field label="Leave a Comment!" outlined v-model="newItem" @keyup.enter.prevent="addItem"></v-text-field>
      </v-col>
      <v-col cols="1">
        <v-btn large color="primary" @click.prevent="addItem">Submit</v-btn>
      </v-col>
    </v-row>
